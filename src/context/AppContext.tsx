  ...
  const addCustomer = (
    ...
    const newCustomer: Customer = {
      ...
      riskAssessment: {
        ...
        riskScore: 100,
        riskLevel: 'low',
        reliabilityRating: 'New Client (Pristine Record)',
        averageDaysToPay: custData.preferredPaymentTermsDays || 14,
        onTimePaymentPercentage: 100,
        paymentConsistency: 'Very High',
        summary: `${custData.name} has been onboarded with zero outstanding arrears.`,
        keyStrengths: ['Clean credit profile', 'Complete contact details provided'],
        riskFactors: ['New relationship with active terms'],
        strategicRecommendation: `Standard Net ${custData.preferredPaymentTermsDays || 14} terms apply.`,
        suggestedPaymentTerms: `Net ${custData.preferredPaymentTermsDays || 14} Days`,
